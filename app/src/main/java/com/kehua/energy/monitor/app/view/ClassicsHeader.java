...
public class ClassicsHeader extends InternalClassics<ClassicsHeader> implements RefreshHeader {
    ...
    public String REFRESH_HEADER_PULLING = null;//"下拉可以刷新";
    public String REFRESH_HEADER_REFRESHING = null;//"正在刷新...";
    public String REFRESH_HEADER_LOADING = null;//"正在加载...";
    public String REFRESH_HEADER_RELEASE = null;//"释放立即刷新";
    public String REFRESH_HEADER_FINISH = null;//"刷新完成";
    public String REFRESH_HEADER_FAILED = null;//"刷新失败";
    public String REFRESH_HEADER_UPDATE = null;//"上次更新 M-d HH:mm";
    public String REFRESH_HEADER_SECONDARY = null;//"释放进入二楼";
