...
@Route(path = RouterMgr.LOCAL_SETTING_GRID)
public class GridFragment extends XMVPFragment<GridPresenter> implements GridContract.View, OnRefreshListener, BaseQuickAdapter.OnItemClickListener {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mAdvancedPresenter.attachView(new AdvancedContract.View() {
            ...
            public void onUpdateData(Object o) {
                GridFragment.this.onUpdateData(o);
            }
            ...
            public void showTipDialog(int opsStatus, String msg) {
                GridFragment.this.showTipDialog(opsStatus, msg);
            }

            @Override
            public void showTipDialog(String msg) {
                GridFragment.this.showTipDialog(msg);
            }

            @Override
            public void startWaiting(String msg) {
                GridFragment.this.startWaiting(msg);
            }

            @Override
            public void stopWaiting() {
                GridFragment.this.stopWaiting();
            }

            @Override
            public void showToast(int opsStatus, String msg) {
                GridFragment.this.showToast(opsStatus, msg);
            }

            @Override
            public void showToast(String msg) {
                GridFragment.this.showToast(msg);
            }

            @Override
            public void finishView() {
                GridFragment.this.finishView();
            }
        });
    }
